...
RM= rm -rf 
SRC= main.c gc_collector.c tokinazer/start_token.c tokinazer/token_type.c tokinazer/utils.c parsing/expand.c parsing/pars.c parsing/pr_utils.c builtin/cd.c builtin/echo.c builtin/env.c builtin/exit.c builtin/export.c \
