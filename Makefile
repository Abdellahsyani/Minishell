...
RM= rm -rf 
SRC= main.c gc_collector.c parsing/rem_free.c parsing/handle_check.c tokinazer/start_token.c tokinazer/token_type.c tokinazer/utils.c parsing/exp_utils2.c parsing/after_expand.c parsing/exp_utils1.c parsing/exp_utils3.c parsing/ex_utils.c parsing/pars_utils1.c parsing/expand.c parsing/pars.c parsing/pars_utils2.c parsing/pr_utils.c builtin/cd.c builtin/echo.c builtin/env.c builtin/exit.c builtin/export.c \
